// Forked from CMR's AnimatedSnowmanCooler.java to integrate with our JEI plugin
...
public class AnimatedSnowmanCooler extends AnimatedKinetics {
    ...
    public void draw(GuiGraphics graphics, int xOffset, int yOffset) {
        ...
        VertexConsumer vb = graphics.bufferSource().getBuffer(RenderType.cutoutMipped());
