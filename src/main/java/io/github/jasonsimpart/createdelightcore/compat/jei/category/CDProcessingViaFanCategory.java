...
public abstract class CDProcessingViaFanCategory<T extends Recipe<?>> extends CreateRecipeCategory<T> {
    protected static final int SCALE = 24;

    public CDProcessingViaFanCategory(Info<T> info) {
        super(info);
    }
    ...
    public static abstract class MultiOutput<T extends ProcessingRecipe<?>> extends CDProcessingViaFanCategory<T> {
