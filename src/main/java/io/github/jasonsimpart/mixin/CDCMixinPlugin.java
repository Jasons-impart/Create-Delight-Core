...
public class CDCMixinPlugin implements IMixinConfigPlugin {
    ...
    private static final List<Rule> RULES = List.of(
            ...
            Rule.forPackage(MIXIN_ROOT + "bakeries.", ModIds.BAKERIES),
            Rule.forPackage(MIXIN_ROOT + "constructionwand.", ModIds.CONSTRUCTION_WAND, ModIds.QUALITY_FOOD),
            Rule.forPackage(MIXIN_ROOT + "createutilities.", ModIds.CREATE_UTILITIES),
            Rule.forPackage(MIXIN_ROOT + "traderefresh.", ModIds.TRADE_REFRESH),
            Rule.forPackage(MIXIN_ROOT + "vinery.", ModIds.VINERY),
            Rule.forPackage(MIXIN_ROOT + "neapolitan.", ModIds.NEAPOLITAN),
            ...
            Rule.forPackage(MIXIN_ROOT + "iceandfire.", ModIds.ICE_AND_FIRE, ModIds.CURIOS),
            ...
            Rule.custom(CREATE_PACKAGE,
                    ...
                    ModIds.CREATE),
            Rule.forClass(MIXIN_ROOT + "minecraft.PlayerMixin", ModIds.CURIOS, ModIds.ICE_AND_FIRE, ModIds.ALEXSCAVES),
