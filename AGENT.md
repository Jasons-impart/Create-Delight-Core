...
- Latest legacy Forge 1.20.1 pack source: `/home/halo/gitRepo/JSI/Create-Delight-Remake/` (designated by the maintainer on 2026-09-18). Check this checkout for newer recipe/material replacements when PTTOD still references unavailable mods. Record the inspected commit; this is a moving reference, not the pinned Core baseline. Read only: never apply PTTOD's migrated-source deletion workflow here.
